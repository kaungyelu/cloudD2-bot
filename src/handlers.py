...
TOKEN = os.getenv("BOT_TOKEN") or env.BOT_TOKEN  # Cloudflare env compatible
...
com_data = {}        # {username: com_percentage}
za_data = {}         # {username: za_amount}
